      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('cars.update', $car->id)}}" method="POST" class="px-md-5">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
           <input type="checkbox" class="form-check-input" style="padding: 0.7rem;" name="published" @checked($car->published) /><input type="checkbox" class="form-check-input" style="padding: 0.7rem;" name="published" @checked($car->published) />
            </div>
          </div>
