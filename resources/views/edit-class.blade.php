      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('classes.update', $class->id)}}" method="POST" class="px-md-5">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" step="0.1" placeholder="Enter price" class="form-control py-2" name="capacity"  value="{{$class->capacity}}"/>
            </div>
          </div>
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">Price:</label>
            <div class="col-md-10">
              <input type="number" step="0.1" placeholder="Enter price" class="form-control py-2" name="price"  value="{{$class->capacity}}"/>
            </div>
          </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="date" step="0.1" placeholder="Enter price" class="form-control py-2" name="timeFrom" value="{{$class->timeFrom}}" />
            </div>
          </div>
          <hr>
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="date" step="0.1" placeholder="Enter price" class="form-control py-2" name="timeTo" value="{{$class->timeTo}}" />
            </div>
          </div>
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">created at:</label>
            <div class="col-md-10">
              <input type="date" step="0.1" placeholder="Enter price" class="form-control py-2" name="updated_at" value="{{$class->updated_at}}" />
            </div>
          </div>
          <hr>
